...
const rankingPages = [
  ...
  {
    href: "/records/women-5000m/season",
    title: "今季女子5000mランキング",
    body: "2026年4月1日以降に出た女子5000mの記録を管理・確認できます。",
  },
  {
    href: "/records/women-10000m/season",
    title: "今季女子10000mランキング",
    body: "2026年4月1日以降に出た女子10000mの記録を管理・確認できます。",
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] text-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-12 pt-28 sm:px-10 lg:px-12">
        <p className="text-sm font-bold tracking-[0.14em] text-cyan-700">RECORDS</p>
        <h1 className="mt-2 text-3xl font-black sm:text-4xl">ランキング</h1>
