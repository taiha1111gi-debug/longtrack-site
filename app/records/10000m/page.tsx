...
import { records10000, toPublicRankingRecords } from "../data";
import { RankingTable } from "../RankingTable";
import { LastUpdated } from "../LastUpdated";

const pageTitle = "日本男子10000m歴代ランキング｜記録・選手一覧";
const pageDescription =
  "日本男子10000mの歴代上位記録を、順位・選手名・タイム・記録当時の所属・大会・場所・日付とともに掲載しています。";
      ...
      <div className="mx-auto max-w-7xl px-4 pb-12 pt-24 sm:px-10 sm:pt-28 lg:px-12">
        <Breadcrumbs
          items={[
            ...
            { label: "日本男子10000m歴代ランキング", href: "/records/10000m" },
          ]}
        />
        <Link
          href="/players"
