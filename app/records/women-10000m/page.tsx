...
import { recordsLastChecked, womenRecords10000 } from "../data";
import { RankingTable } from "../RankingTable";
import { LastUpdated } from "../LastUpdated";

export default function WomenRecords10000mPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 pb-12 pt-28 sm:px-10 lg:px-12">
        ...
        <section className="mt-6 rounded-md border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          <p className="text-sm font-bold tracking-[0.14em] text-cyan-700">
            WOMEN 10000m RECORDS
          </p>
          <h1 className="mt-1 text-3xl font-black sm:text-4xl">
            女子10000m歴代ランキング
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
            女子10000mの歴代上位記録をまとめています。
          </p>
          <RankingTable records={womenRecords10000} />
          <LastUpdated value={recordsLastChecked.womenRecords10000m} />
        </section>
      </div>
    </main>
  );
