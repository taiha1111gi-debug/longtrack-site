...
export function RankingTable({ records }: { records: PublicRankingRecord[] }) {
  ...
  return (
    <>
      <div className="mt-4 rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-[11px] leading-4 text-slate-600 md:hidden">
            ...
            <div className="flex items-baseline justify-between gap-2">
              <div className="min-w-0">
                ...
                <Link
                  ...
                  className="break-words text-sm font-black leading-5 text-slate-900 underline decoration-slate-900 decoration-2 underline-offset-4 hover:text-cyan-700"
                >
                  {runner.name}
                </Link>
